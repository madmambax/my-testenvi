...
${TEXT_CHYBNE_HESLO}   Zadal(a) jste nesprávný e-mail nebo heslo.
${USER_CHYBNY_EMAIL}   chyba
${USER_CHYBNE_HESLO}   bad
${TEXT_VSE_OK}         MS
${PRODUKT}             mléko
${ID_PRODUKT}          1320669
...
*** Test Cases ***
Login spatny email
    Login           ${USER_CHYBNY_EMAIL}           ${USER1_PWD}                     ${TEXT_CHYBNY_EMAIL}

Login spatne heslo
    Login           ${USER1_EMAIL}                 ${USER_CHYBNE_HESLO}             ${TEXT_CHYBNE_HESLO}

Login vse OK
    Login           ${USER1_EMAIL}                 ${USER1_PWD}                     ${TEXT_VSE_OK}
    Logout

Test Objednavky
    ${kusu} =	        Set Variable	            5
    Login               ${USER1_EMAIL}           ${USER1_PWD}                             ${TEXT_VSE_OK}
    Pridat do kosiku    ${PRODUKT}               ${ID_PRODUKT}                            ${kusu}
