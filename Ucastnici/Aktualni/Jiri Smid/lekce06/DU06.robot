...
Registrace moc dlouhe jmeno
    ...
    Log                Dlouhe jmeno je OK, nejsou nastaveny horni hranicni hodnoty
...
Registrace kratke jmeno
    ...
    Log                Kratke jmeno je OK, neni nastavena dolni hranicni hodnota
...
Registrace ciselne znaky jmeno
    ...
    Log                Jmeno pouze z ciselnych znaku OK
...
Registrace specialni znaky adress
    ...
    Log                Adress akceptuje specialni znaky
...
Registrace vysoky pocet osob (999999999999999999)
    ...
    Log                Registraci prochazi i vysoky pocet osob
...
Registrace spatny format ico (XcZ54UJkj569gvfvD5D)
    ...
    Log                Formular dovoluje registraci i s nespravnym formatem hodnoty ico
