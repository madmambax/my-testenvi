...
*** Variables ***
${URL}                  https://rohlik.cz
${Login}                bavemal543@cebaike.com
${BadPassword}          bad
${BadLogin}             chyba
${RightPassword}        tajneheslotajneheslo
${Goods}                mléko
${IdGoods}              1320669
${CheckMessage}         MS
${MessageBadLogin}      Zadejte platný email
${MessageLoginOrPas}    Špatné heslo nebo e-mail
${CartPath}             id=cartContent

*** Test Cases ***
Login spatny email
    Login           ${BadLogin}                ${RightPassword}                  ${MessageBadLogin}

Login spatne heslo
    Login           ${RightPassword}           ${BadPassword}                     ${MessageLoginOrPas}

Login vse OK
    Login           ${Login}                   ${RightPassword}                   ${CheckMessage}
    Logout

Test Objednavky
    ${kusu} =	        Set Variable	            5
    Login               ${Login}                    ${RightPassword}                ${CheckMessage}
    Pridat do kosiku    ${Goods}                    ${IdGoods}                      ${kusu}
