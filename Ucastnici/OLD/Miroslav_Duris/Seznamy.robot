...
Cvičení na proměnné typu 'seznam'
    ...
    ${Scalar2} =  Create List    1. polozka  2. polozka  3. polozka     # Jednotlivý položky považuje asi za 'stringy'.
    Log To Console    ${\n}Výpis 2. seznamu:${\n}${Scalar2}
    Log To Console    2. položka seznamu:${\n}${Scalar2}[1]   # Syntaxe vypsání položky ze 'skalárního' seznamu.
    Log To Console    -----------------------------------------
    ...
    Log To Console    2. položka seznamu:${\n}${list3}[2]   # Syntaxe vypsání položky ze 'skalárního' seznamu.
    ...
    # A nevypadá to ani jako 'string'. Je to 'tuple'?  (1, 2, 3)
    Log To Console    2. položka seznamu:${\n}${list4}[2]
