...
*** Test Cases ***
# Opravit selektory u všech 4 testcasů.

1. Login spatny email
    Login           chyba                       tajneheslotajneheslo                    Zadejte platný email

2. Login spatne heslo
...
#   Z console> [ WARN ] Open Browser is for quick experimentation and debugging only. Use New Page for production.
    New Page                    ${URL}
