...
Při používání diakritiky (háčky, čárky, kroužky ad.) se může objevit fail s errorem>
UnicodeEncodeError
To se dá vyřešit tím, že test. data pošlu nejdřív do klíč. slova 'Encode String To Bytes'; a až potom do POST, GET atd.
