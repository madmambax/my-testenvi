...
*** Test Cases ***
Login uzivatel overeno v KS
    [Documentation]  	Uspesne prihlaseni uzivatele s vnorenym navratovym kodem
    Login   novak       tajnenovak  200

Login uzivatel overeno v KS
    [Documentation]  	Neuspesne prihlaseni uzivatele s vnorenym navratovym kodem
    Login   novak       tajne  403

Login admin overeno v KS
    [Documentation]  	Uspesne prihlaseni admina s vnorenym navratovym kodem
    Login   admin       tajneadmin  200

Login admin overeno v KS
    [Documentation]  	Neuspesne prihlaseni admina  s vnorenym navratovym kodem
    Login   novak       tajne   403
...
Login
    # argumenty se přiřazují podle pořadí   Login   novak       tajnenovak  200
